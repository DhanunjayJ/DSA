...
It is a brilliant question. The fact that Phase 2 works perfectly seems like pure magic until you break down the algebra. Here is exactly why moving one pointer from the start and one from the intersection guarantees they meet at the duplicate.
...
Does this algebraic breakdown make it easier to visualize why the two pointers perfectly align at the duplicate number?
---

##Piegion Hole principle
